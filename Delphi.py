...
driver.get('http://delphi.chennairfid.com/admin/manage-employees/')
...
for i in range(r):
    driver.get('http://delphi.chennairfid.com/admin/manage-employees/?evnt=new&did=1')
