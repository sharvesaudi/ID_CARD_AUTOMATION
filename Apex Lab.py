...
driver.get('http://apex.chennairfid.com/admin/manage-employees/')

# Login with admin
passs = driver.find_element("name", "admin_password")
passs.send_keys("Apex032")
btn = driver.find_element("name", "login_submit")
btn.click()

# click general
element = driver.find_element("xpath", "/html/body/center/table/tbody/tr[7]/td[2]/a")
element.click()
...
for i in range(r):
    driver.get('http://apex.chennairfid.com/admin/manage-employees/?evnt=new&did=1')
