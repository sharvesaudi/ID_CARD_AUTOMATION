...
path = "C:/Users/sharv/Downloads/chromedriver_win32teast/chromedriver"

driver = webdriver.Chrome(path)

# Navigate to the webpage
driver.get('http://lucas-pondy.chennairfid.com/admin/')

# Login with admin
passs = driver.find_element("name", "admin_password")
passs.send_keys("Lucas102")
...
for i in range(r):
    driver.get('http://lucas-pondy.chennairfid.com/admin/manage-employees/?evnt=new&did=1')
    ...
    ele4 = driver.find_element("name", "employee_photo")
    ele4.send_keys(str(df.iloc[i][3])) 

    ele5 = driver.find_element("name", "employee_sign")
